<?php
  $analytics_ref_link = '?utm_source=sitemap&utm_medium=referral&utm_campaign=sitemap';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<div class="container">
  <div class="sitemap">
    <div class="row">
      <div class="col-lg-12"><h1>Website Sitemap</h1></div>
    </div>
    <div class="row">
      <div class="col-md-6">
          ...
          <div class="panel-body">
              ...
              <a href="http://freetemplatesdownload.info/<?php echo $analytics_ref_link; ?>" class="list-group-item">Home <small>www.freetemplatesdownload.info</small></a>
              <a href="http://freetemplatesdownload.info/all-templates.html<?php echo $analytics_ref_link; ?>" class="list-group-item">All templates <small>/all-templates.html</small></a>
              <a href="http://freetemplatesdownload.info/sitemap.html<?php echo $analytics_ref_link; ?>" class="list-group-item">Website sitemap <small>/sitemap.html</small></a>
              </div>
          </div>
          </div>
          ...
          <div class="panel-body">
              <div class="list-group">
              <a href="http://freetemplatesdownload.info/livepreview/businessbox/<?php echo $analytics_ref_link; ?>" class="list-group-item">BusinessBox <small>/livepreview/businessbox/</small></a>
              <a href="http://freetemplatesdownload.info/livepreview/urbanprism/<?php echo $analytics_ref_link; ?>" class="list-group-item">UrbanPrism <small>/livepreview/urbanprism/</small></a>
              <a href="http://freetemplatesdownload.info/livepreview/freshco/<?php echo $analytics_ref_link; ?>" class="list-group-item">FreshCO <small>/livepreview/freshco/</small></a>
              <a href="http://freetemplatesdownload.info/livepreview/yourcoolportfolio/<?php echo $analytics_ref_link; ?>" class="list-group-item">YourCoolPortfolio <small>/livepreview/yourcoolportfolio/</small></a>
              <a href="http://freetemplatesdownload.info/livepreview/yourflatportfolio/<?php echo $analytics_ref_link; ?>" class="list-group-item">YourFlatPortfolio <small>/livepreview/yourflatportfolio/</small></a>
              <a href="http://freetemplatesdownload.info/livepreview/purity/<?php echo $analytics_ref_link; ?>" class="list-group-item">Purity <small>/livepreview/purity/</small></a>
              </div>
          </div>
          </div>
      </div>
